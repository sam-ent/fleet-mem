...
class MerkleDAG:
    """A content-addressable DAG where each node is a file path mapped to its xxHash digest."""

    def __init__(self):
        self._nodes: dict[str, str] = {}

    def add_node(self, path: str, content: bytes) -> str:
        """Add a file node. Returns the xxh3_64 hash of the content."""
    ...
    def root_hash(self) -> str:
        """xxh3_64 of sorted concatenated child hashes."""
        if not self._nodes:
